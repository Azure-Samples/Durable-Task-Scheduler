...
$MainAppImage = Build-Image "dts-ondemand-sandboxes/main-app-$EnvName" "Containerfile.mainapp"
$SandboxImage = Build-Image "dts-ondemand-sandboxes/sandbox-worker-$EnvName" "Containerfile"
