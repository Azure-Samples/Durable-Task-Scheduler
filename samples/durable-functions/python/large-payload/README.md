<!--
---
description: This sample demonstrates large payload support in Python Durable Functions with the Durable Task Scheduler.
page_type: sample
products:
- azure-functions
- durable-functions
...
- azure
- entra-id
urlFragment: large-payload-python
languages:
- python
---
-->

# Large Payload Support - Python Durable Functions
...
```
large-payload/
├── function_app.py      # Function definitions (orchestrator, activity, HTTP trigger)
├── host.json            # Host configuration with large payload storage settings
...
```json
{
  ...
  "output": {
    "items_processed": 5,
    "total_size_kb": 500,
    "individual_sizes": [100, 100, 100, 100, 100]
  }
}
```
