...
module blobDataOwnerAssignmentUami 'app/storage-Access.bicep' = {
  name: 'blobDataOwnerAssignmentUami'
  scope: rg
  params: {
    storageAccountName: storage.outputs.name
...
module tableDataContributorAssignmentUami 'app/storage-Access.bicep' = {
  name: 'tableDataContributorAssignmentUami'
  scope: rg
  params: {
    storageAccountName: storage.outputs.name
...
module queueDataContributorAssignmentUami 'app/storage-Access.bicep' = {
  name: 'queueDataContributorAssignmentUami'
  scope: rg
  params: {
    storageAccountName: storage.outputs.name
