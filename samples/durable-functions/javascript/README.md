### Azure Durable Functions (JavaScript / TypeScript)
...
These samples demonstrate how to use Durable Functions with JavaScript/TypeScript and the Durable Task Scheduler backend.
