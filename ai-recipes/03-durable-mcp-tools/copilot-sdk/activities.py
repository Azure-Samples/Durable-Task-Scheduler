"""HTTP activities for GitHub REST API calls used by the durable MCP tools."""
...
DEFAULT_USER_AGENT = os.getenv(
    'GITHUB_USER_AGENT',
    'durable-task-ai-hub/03-durable-mcp-tools/copilot-sdk (+https://github.com/microsoft/durabletask-python)',
)
